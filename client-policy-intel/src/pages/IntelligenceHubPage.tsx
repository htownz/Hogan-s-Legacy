...
const ForecastTab = lazy(() => import("./IntelligenceHubDeepTabs").then((mod) => ({ default: mod.ForecastTab })));
const SponsorsTab = lazy(() => import("./IntelligenceHubDeepTabs").then((mod) => ({ default: mod.SponsorsTab })));
const HistoricalTab = lazy(() => import("./IntelligenceHubDeepTabs").then((mod) => ({ default: mod.HistoricalTab })));
const LegislatorsTab = lazy(() => import("./IntelligenceHubDeepTabs").then((mod) => ({ default: mod.LegislatorsTab })));
const InfluenceMapTab = lazy(() => import("./IntelligenceHubDeepTabs").then((mod) => ({ default: mod.InfluenceMapTab })));
...
export function IntelligenceHubPage() {
  ...
  return (
    <div>
      ...
      {(tab === "forecast" || tab === "sponsors" || tab === "historical" || tab === "legislators" || tab === "influenceMap") && (
        <Suspense fallback={<DeepTabLoadingState label={tabs.find((entry) => entry.key === tab)?.label ?? "Analysis"} />}>
...
function DeepTabLoadingState({ label }: { label: string }) {
  return (
    <div
      style={{
        background: "#fff",
